---
name: ai-job-advisor
description: AI 求职顾问，帮助分析岗位、优化和生成简历、准备面试、设计 HR 跟进话术、谈薪和管理求职进展。Use when the user asks for job search advice, resume generation or optimization, interview preparation, HR follow-up, offer negotiation, or job-search progress tracking in Chinese.
---
...
- 圆形头像放在右上角
- 专业 bullet 列表样式
- 底部可选 `Powered by AI Job Advisor Skill`
...
- **运势仅供娱乐**：不替代实际求职行动
- **打招呼语前十七字原则**：为用户设计 Boss 直聘/猎头打招呼语时，前 17 个字必须暴露最关键信息（岗位核心关键词 + 用户最稀缺标签），避免用泛泛问候或"我对岗位很感兴趣"等废话占用黄金位置
